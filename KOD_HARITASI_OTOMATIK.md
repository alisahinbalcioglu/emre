...
| `backend/src/ozellik/odeme/abonelik/abonelik.controller.ts` | 246 |
...
| `backend/src/ozellik/odeme/abonelik/satinalma.servisi.ts` | 1582 |
...
| `backend/test/regression-all.ts` | 919 |
