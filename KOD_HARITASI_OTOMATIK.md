...
| Dosya | Satir |
|---|---|
| `backend/prisma/schema.prisma` | 2051 |
...
| `frontend/ozellik/odeme/abonelik-ozeti.test.ts` | 628 |
...
| `frontend/ozellik/odeme/erisim-durumu.ts` | 191 |
...
| `frontend/ozellik/odeme/turkce-metin.test.ts` | 572 |
