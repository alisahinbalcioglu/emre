...
| `backend/src/ozellik/odeme/abonelik/abonelik.servisi.ts` | 984 |
...
| `backend/src/ozellik/odeme/abonelik/satinalma.servisi.ts` | 1459 |
...
| `backend/test/paket-degisimi-test.ts` | 1376 |
