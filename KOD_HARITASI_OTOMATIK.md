...
| `backend/src/ozellik/odeme/abonelik/abonelik.controller.ts` | 254 |
...
| `backend/src/ozellik/odeme/abonelik/satinalma.servisi.ts` | 1528 |
...
| `backend/test/regression-all.ts` | 921 |
