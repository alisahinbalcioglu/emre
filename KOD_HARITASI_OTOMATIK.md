...
| `backend/src/ozellik/odeme/abonelik/paket-degisimi.servisi.ts` | 716 |
...
| `backend/src/ozellik/odeme/abonelik/yonetici/yonetici-islemi.ts` | 209 |
...
| `backend/test/regression-all.ts` | 762 |
...
| `backend/test/yonetici-paket-test.ts` | 1183 |
