...
| `backend/src/ozellik/odeme/abonelik/abonelik.servisi.ts` | 1036 |
...
| `backend/src/ozellik/odeme/abonelik/satinalma.servisi.ts` | 1452 |
...
| `backend/test/regression-all.ts` | 798 |
