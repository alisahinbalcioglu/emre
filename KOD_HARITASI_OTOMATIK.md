...
| `backend/src/ozellik/odeme/abonelik/abonelik.servisi.ts` | 1318 |
...
| `backend/src/ozellik/odeme/webhook/webhook.isleyici.ts` | 137 |
...
| `backend/test/regression-all.ts` | 805 |
