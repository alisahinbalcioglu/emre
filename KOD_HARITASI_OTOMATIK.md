...
| `backend/src/ozellik/odeme/abonelik/abonelik.servisi.ts` | 1388 |
...
| `backend/src/ozellik/odeme/webhook/webhook.isleyici.ts` | 138 |
...
| `backend/test/odeme-imha-test.ts` | 855 |
...
| `backend/test/regression-all.ts` | 809 |
