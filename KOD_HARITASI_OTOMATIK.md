...
| `backend/src/ozellik/odeme/abonelik/abonelik.servisi.ts` | 1412 |
...
| `backend/src/ozellik/odeme/abonelik/erisim.servisi.ts` | 491 |
...
| `backend/test/paket-degisimi-test.ts` | 1386 |
...
| `backend/test/regression-all.ts` | 820 |
