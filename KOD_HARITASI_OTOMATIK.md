...
| `backend/src/ozellik/odeme/abonelik/abonelik.servisi.ts` | 966 |
...
| `backend/src/ozellik/odeme/abonelik/satinalma.servisi.ts` | 1443 |
...
| `backend/test/regression-all.ts` | 794 |
