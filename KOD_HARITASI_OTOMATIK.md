...
| `backend/src/ozellik/odeme/abonelik/abonelik.servisi.ts` | 1365 |
...
| `backend/src/ozellik/odeme/abonelik/satinalma.servisi.ts` | 1492 |
...
| `backend/test/paket-degisimi-test.ts` | 1421 |
...
| `backend/test/regression-all.ts` | 851 |
