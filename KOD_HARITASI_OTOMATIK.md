...
| `backend/src/ozellik/odeme/abonelik/abonelik.servisi.ts` | 1300 |
...
| `backend/test/havale-iyzico-cakismasi-test.ts` | 1642 |
...
| `backend/test/odeme-imha-test.ts` | 853 |
...
| `backend/test/regression-all.ts` | 775 |
