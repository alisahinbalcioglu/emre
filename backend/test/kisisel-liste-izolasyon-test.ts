...
async function main() {
  ...
  const adminSvc = new AdminService(prisma, {} as any, fakeTerminology, { iptalEt: async () => undefined } as any, { gonder: async () => undefined } as any);
  ...
  // ── 23.09.2026 (Ekip & Izinler, guvenlik incelemesi MEDIUM) ──────────────
  // Kisisel liste firmanin Kutuphanem verisidir: AYNI firmanin izni kapali
